...
$.each(RegionesYcomunas.regions, function () {
htmlRegion = htmlRegion + '<option value="' + RegionesYcomunas.regions[iRegion].abbreviation + '">' + RegionesYcomunas.regions[iRegion].name + '</option>';
iRegion++;
});
...
$.each(RegionesYcomunas.regions, function () {
if (RegionesYcomunas.regions[iRegiones].abbreviation == valorRegion) {
var iComunas = 0;
$.each(RegionesYcomunas.regions[iRegiones].communes, function () {
htmlComuna = htmlComuna + '<option value="' + RegionesYcomunas.regions[iRegiones].communes[iComunas].name + '">' + RegionesYcomunas.regions[iRegiones].communes[iComunas].name + '</option>';
iComunas++;
});
}
iRegiones++;
